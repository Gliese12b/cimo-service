...
import { ApiListResponseDto, ApiResponseDto } from '../@types/dtos';
...
export class ResponseInterceptor<T> implements NestInterceptor<T> {
   ...
   */
  intercept(_context: ExecutionContext, next: CallHandler): Observable<ApiResponseDto<T> | ApiListResponseDto<T>> {
